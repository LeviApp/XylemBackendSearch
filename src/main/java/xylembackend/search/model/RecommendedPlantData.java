...
public class RecommendedPlantData {
    ...
    private Long total_recommends;
    private String recommended_to;

    public RecommendedPlantData() {

    }

    public RecommendedPlantData(Integer id, String user_id, String common_name, String scientific_name, String family_common_name, String family, String genus, Integer year, String image_url, Long total_recommends, String recommended_to) {
        this.id = id;
        ...
        this.total_recommends = total_recommends;
    ...
    public Long gettotal_recommends() {
        return total_recommends;
    }

    public void settotal_recommends(Long total_recommends) {
        this.total_recommends = total_recommends;
    }
